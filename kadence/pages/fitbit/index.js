...
export default function Display() {
    ...
    async function connectDevice(e) {
        ...
        try {
            ...
            window.location.assign('https://www.fitbit.com/oauth2/authorize?response_type=code&client_id=23QTD8&scope=cardio_fitness+electrocardiogram+heartrate+profile+settings&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Ffitbit');
                ...
                <main className={[inter.className, styles.main].join(' ')}>
                    ...
                    >
                        ...
                        <ThemeProvider theme={theme}>
                            <Button type="submit" variant="contained" className={`${styles.connectButton}`}>
                                Connect
                            </Button>
                        </ThemeProvider>
                    </form>
